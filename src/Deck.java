...
public class Deck extends JFrame{
    ...
    public void createcharacter(){
        Jeff = new Character(100,100,"Images/Snore.gif");
        this.add(Jeff);
    ...
    public void setCardName(int i){
        if(i==0) {
            do {
                ...
                int b = gen.nextInt(4);
                if (grid[a][b] == null) {
                    Card temp = new Card(0, 0, 100, 100,"Images/2x4.png", 2);
                    tower[0] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==1) {
            do {
                ...
                int b = gen.nextInt(5);
                if (grid[a][b] == null) {
                    Card temp = new Card(100, 0, 100, 100,"Images/2x4.png", 2);
                    tower[1] = temp;
        ...
        if(i==2) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/ConeofShame.png", 4);
                    tower[2] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==4) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/Cylinder.png", 6);
                    tower[4] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==6) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/HayBale.png", 8);
                    tower[6] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==8) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/Hexagon.png", 10);
                    tower[8] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==10) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0,0, 100, 100,"Images/Hexagon2.png", 12);
                    tower[10] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==12) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/Pyramid.png", 14);
                    tower[12] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==14) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/Pyramid2.png", 16);
                    tower[14] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==16) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0,0, 100, 100,"Images/Rectangle.png", 18);
                    tower[16] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
        ...
        if(i==18) {
            do {
                ...
                if (grid[a][b] == null) {
                    ...
                    Card temp = new Card(0, 0, 100, 100,"Images/Square.png", 20);
                    tower[18] = temp;
                    there = true;
                    grid[a][b] = temp;
                }
